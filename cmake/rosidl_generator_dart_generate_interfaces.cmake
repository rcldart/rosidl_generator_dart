# Copyright 2024-2025 Harun KURT <harunkurt.dev@gmail.com>
#
...
rosidl_generator_dart_get_typesupports(_typesupport_impls)
...
set(_output_path
  "${CMAKE_CURRENT_BINARY_DIR}/rosidl_generator_dart/${PROJECT_NAME}")
...
set(target_dependencies
  "${rosidl_generator_dart_BIN}"
  ${rosidl_generator_dart_GENERATOR_FILES}
  "${rosidl_generator_dart_TEMPLATE_DIR}/action.c.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/action.cs.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/action.h.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/idl.c.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/idl.cs.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/idl.h.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/msg.c.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/msg.cs.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/msg.h.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/srv.c.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/srv.cs.em"
  "${rosidl_generator_dart_TEMPLATE_DIR}/srv.h.em"
...
set(generator_arguments_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_generator_dart__arguments.json")
rosidl_write_generator_arguments(
  ...
  TEMPLATE_DIR "${rosidl_generator_dart_TEMPLATE_DIR}"
...
if(_generated_cs_files)
  add_custom_command(
    ...
    ARGS ${rosidl_generator_dart_BIN}
...
if(_generated_c_ts_files)
  ...
  target_include_directories(${_target_name}
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/rosidl_generator_dart
  )
